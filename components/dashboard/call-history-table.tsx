      ...
      <CardHeader>
        ...
        <div className="flex flex-col sm:flex-row gap-4 mt-4">
          ...
          <div className="flex gap-2">
            ...
            <Select value={leadQualityFilter} onValueChange={onLeadQualityFilterChange}>
              <SelectTrigger className="w-32">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-8">
            ...
            <p className="text-muted-foreground">
              {searchTerm || sentimentFilter !== 'all' || leadQualityFilter !== 'all' || statusFilter !== 'all'
                ...
                <TableBody>
                  {calls.map((call) => (
                    ...
                    >
                      ...
                      <TableCell>{getStatusBadge(call.endedReason)}</TableCell>
                      <TableCell>
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-3">
                      <div className="flex justify-between items-start">
                        <div>
                          <p className="font-medium">{call.phoneNumber?.number || 'Unknown'}</p>
