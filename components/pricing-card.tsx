  ...
  return (
    <div className="w-full max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-center mb-8">
        <div className="flex items-center space-x-3 p-1 bg-card/20 backdrop-blur-glass border border-white/10 rounded-full">
          <button
          ...
          return (
            <Card 
              ...
              className={cn(
                ...
                tier.popular 
                  ? "border-primary/50 bg-card/30 shadow-glow-primary/20 scale-105" 
              ...
              <CardFooter className="flex flex-col space-y-3">
                ...
                >
                  <Link href={tier.ctaText === 'Contact Sales' ? '/contact' : '/signup'}>
                    ...
                    {tier.popular && <Zap className="w-4 h-4 ml-2" />}
                  </Link>
                </Button>
              </CardFooter>
            </Card>
