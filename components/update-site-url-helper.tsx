  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Update the site URL in Supabase to fix email confirmation links
        </CardDescription>
      </CardHeader>
      <CardContent>
        <p className="mb-4 text-sm text-muted-foreground">
          The email confirmation links are still using localhost:3000 instead of
          your deployed site URL. This helper will attempt to update the
          configuration, but you may need to update it manually in the Supabase
          dashboard.
        </p>
            ...
            <li>
              ...
              <code className="rounded bg-gray-100 px-1 py-0.5">
                {process.env.NEXT_PUBLIC_SITE_URL ||
                  'https://v0-image-analysis-chi-five-88.vercel.app'}
              </code>
            </li>
            <li>
