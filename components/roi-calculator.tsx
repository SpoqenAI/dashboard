...
export function ROICalculator() {
  ...
  return (
    <Card className="mx-auto max-w-4xl overflow-hidden border border-white/10 bg-card/10 hover:shadow-glow-primary/20 transition-all duration-300 hover:scale-105 hover:bg-card/20">
